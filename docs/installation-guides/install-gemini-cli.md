...
`gemini extensions install https://github.com/github/mcp-project-brain`
...
You can download the latest binary release from the [GitHub releases page](https://github.com/github/mcp-project-brain/releases) or build it from source by running `go build -o mcp-project-brain ./cmd/mcp-project-brain`.
