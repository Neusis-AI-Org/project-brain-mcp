...
> **Server naming:** Name your server `mcp-project-brain` to replace the built-in server, or use a different name (e.g., `github`) to run alongside it.
...
You can download the latest binary release from the [GitHub releases page](https://github.com/github/mcp-project-brain/releases) or build it from source by running:
