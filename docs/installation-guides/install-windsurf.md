...
**Important**: The npm package `@modelcontextprotocol/server-github` is no longer supported as of April 2025. Use the official Docker image `ghcr.io/github/mcp-project-brain` instead.
...
- **Official repository**: [github/mcp-project-brain](https://github.com/github/mcp-project-brain)
- **Remote server URL**: `https://api.githubcopilot.com/mcp/`
- **Docker image**: `ghcr.io/github/mcp-project-brain` (official and supported)
