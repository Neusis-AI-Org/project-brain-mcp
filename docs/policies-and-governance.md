...
For integration architecture and implementation details, see the [Host Integration Guide](https://github.com/github/mcp-project-brain/blob/main/docs/host-integration.md).
...
Open an [issue in the mcp-project-brain repository](https://github.com/github/mcp-project-brain/issues) with the label "policies & governance" attached.
