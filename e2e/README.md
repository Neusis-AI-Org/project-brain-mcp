 ...
 * Building the `mcp-project-brain` docker image
 * Running the image
...
=== RUN   TestE2E/CallTool_get_me
    e2e_test.go:85:
                Error Trace:    /Users/williammartin/workspace/mcp-project-brain/e2e/e2e_test.go:85
                Error:          Not equal:
                                expected: "foobar"
...
FAIL
FAIL    github.com/github/mcp-project-brain/e2e 1.433s
FAIL
```
