...
- **Primary Package:** mcp-project-brain (stdio MCP server - **this is the main focus**)
...
- **.gitignore:** Excludes bin/, dist/, vendor/, *.DS_Store, mcp-project-brain binary
...
1. **PRIMARY FOCUS:** The local stdio MCP server (mcp-project-brain) - this is what you should work on and test with
