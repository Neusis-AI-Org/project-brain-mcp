...
func Test_hasFilter(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			query:      "repo:github/mcp-project-brain critical bug",
			filterType: "repo",
			expected:   true,
		},
		{
		...
		},
		{
			...
			query:      "repo:github/mcp-project-brain is:issue (label:critical OR label:urgent)",
			filterType: "is",
			expected:   true,
		},
		{
...
func Test_hasRepoFilter(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			query:    "repo:github/mcp-project-brain is:issue",
			expected: true,
		},
		{
