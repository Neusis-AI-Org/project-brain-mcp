...
Examples:
  ...
  mcp-project-brain list-scopes

  # List scopes for specific toolsets
  mcp-project-brain list-scopes --toolsets=repos,issues,pull_requests

  # List scopes for all toolsets
  mcp-project-brain list-scopes --toolsets=all

  # Output as JSON
  mcp-project-brain list-scopes --output=json

  # Just show unique scopes needed
  mcp-project-brain list-scopes --output=summary`,
